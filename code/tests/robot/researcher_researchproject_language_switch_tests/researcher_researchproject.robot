...
*** Test Cases ***
Test Language Switching On Researcher Research Project     
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้าโครงการวิจันในส่วนของผู้วิจัย   
    Go To    ${RESEARCH_PROJECT_URL}
    Verify Language    Research Project    
    Switch Language    th
    Verify Language    โครงการวิจัย      
    Switch Language    cn
    Verify Language    研究项目    
