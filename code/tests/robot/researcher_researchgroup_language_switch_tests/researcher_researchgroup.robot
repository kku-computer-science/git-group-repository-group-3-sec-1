...
${RESEARCH_GROUP_URL}        http://127.0.0.1:8000/researchGroups
...
*** Test Cases ***
Test Language Switching On Researcher Research Group   
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้ากลุ่มวิจัยในส่วนของผู้วิจัย   
    Go To    ${RESEARCH_GROUP_URL}
    Verify Language    Research Group  
    Switch Language    th
    Verify Language    กลุ่มวิจัย      
    Switch Language    cn
    Verify Language    研究小组    
