...
${USER_URL}    xpath=//a[contains(@href, '/users')]
${IMPORT_NEW_USER_URL}    xpath=//a[contains(@href, '/importfiles')]
${CREATE_USER_URL}    xpath=//a[contains(@href, '/users/create')]
${SHOW_USER_DEMO_URL}    xpath=//a[contains(@href, '/users/1')]
${ROLE_URL}    xpath=//a[contains(@href, '/roles')]
${CREATE_ROLE_URL}    xpath=//a[contains(@href, '/roles/create')]
${SHOW_ROLE_DEMO_URL}    xpath=//a[contains(@href, '/roles/5')]
${PERMISSION_URL}    xpath=//a[contains(@href, '/permissions')]
${CREATE_PERMISSION_URL}    xpath=//a[contains(@href, '/permissions/create')]
${SHOW_PERMISSION_DEMO_URL}    xpath=//a[contains(@href, '/permissions/1')]
...
${MANAGE_EXPERTISE_URL}    xpath=//a[contains(@href, '/experts')]
...
Verify English User Page
    Verify User Page English  

Verify English Role Page
    Verify Role Page English  

Verify English Permission Page
    Verify Permission Page English  
...
Verify English Manage Expertise Page
    Verify Manage Expertise Page English  
...
Verify Thai User Page
    Verify User Page Thai  

Verify Thai Role Page
    Verify Role Page Thai  

Verify Thai Permission Page
    Verify Permission Page Thai  
...
Verify Thai Manage Expertise Page
    Verify Manage Expertise Page Thai
...
Verify Chinese User Page
    Verify User Page Chinese  

Verify Chinese Role Page
    Verify Role Page Chinese  

Verify Chinese Permission Page
    Verify Permission Page Chinese  
...
Verify Chinese Manage Expertise Page
    Verify Manage Expertise Page Chinese
...
Verify Research Group Page English 
    ...
    Wait Until Page Contains    Description (TH)
    Wait Until Page Contains    Description (EN)
    Wait Until Page Contains    Description (CN)
    Wait Until Page Contains    Detail (TH)
    Wait Until Page Contains    Detail (EN)
    Wait Until Page Contains    Detail (CN)
    Wait Until Page Contains    Research Group Image
...
Verify User Page English    
    ...
    Wait Until Page Contains    Next    
    # Verify create.blade.php
    Click Element    ${CREATE_USER_URL}
    Wait Until Page Contains    Create User
    Wait Until Page Contains    Input User Detail
    Wait Until Page Contains    First Name (TH)
    Wait Until Page Contains    Last Name (TH)
    Wait Until Page Contains    First Name (EN)
    Wait Until Page Contains    Last Name (EN)
    Wait Until Page Contains    First Name (CN)
    Wait Until Page Contains    Last Name (CN)
    Wait Until Page Contains    Email
    Wait Until Page Contains    Password
    ...
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify Import new user
    Click Element    ${IMPORT_NEW_USER_URL}
    Wait Until Page Contains    Import Excel, CSV File
    Wait Until Page Contains    Submit
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify show.blade.php
    Click Element    ${SHOW_USER_DEMO_URL}
    Wait Until Page Contains    User Detail   
    Wait Until Page Contains    Description of the user
    Wait Until Page Contains    Full Name (TH)
    Wait Until Page Contains    Full Name (EN)
    Wait Until Page Contains    Full Name (CN)
    Wait Until Page Contains    Email
    Wait Until Page Contains    Role
    Wait Until Page Contains    Password
    Wait Until Page Contains    Back
    ...
    Click Element    ${USER_URL}
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@data-original-title='Edit'])[1]
    Wait Until Page Contains    Edit User     
    Wait Until Page Contains    Edit User Detail
    Wait Until Page Contains    First Name (TH) 
    Wait Until Page Contains    Last Name (TH) 
    Wait Until Page Contains    First Name (EN)
    Wait Until Page Contains    Last Name (EN)
    ...
    Click Element    ${USER_URL}
    # Verify Delete Message
    Click Element    xpath=(//button[contains(@class, 'btn-outline-danger')])[1]
    Wait Until Page Contains    Are you sure?
    Wait Until Page Contains    If you delete this, it will be gone forever.
    Wait Until Page Contains    Cancel
    Wait Until Page Contains    Submit
...
Verify Role Page English
    ...
    Wait Until Page Contains    Action
    # Verify create.blade.php
    Click Element    ${CREATE_ROLE_URL}
    Wait Until Page Contains    Create Role
    Wait Until Page Contains    Role Name
    Wait Until Page Contains    Permission
    Wait Until Page Contains    Submit
    Wait Until Page Contains    Cancel  
    # Back to index.blade.php
    Click Element    ${ROLE_URL}    
    # Verify show.blade.php
    Click Element    ${SHOW_ROLE_DEMO_URL}
    Wait Until Page Contains    Roles 
    Wait Until Page Contains    Role Detail
    Wait Until Page Contains    Role Name
    Wait Until Page Contains    Permission
    Wait Until Page Contains    Back
    # Back to index.blade.php
...
Verify Permission Page English
    Click Element    ${PERMISSION_URL}
    # Verify index.blade.php
    Wait Until Page Contains    Permissions
    Wait Until Page Contains    New Permission
    Wait Until Page Contains    Permission Name
    Wait Until Page Contains    Action
    Wait Until Page Contains    Search:
    Wait Until Page Contains    Previous
    Wait Until Page Contains    Next    
    # Verify create.blade.php
    Click Element    ${CREATE_PERMISSION_URL}
    Wait Until Page Contains    Create Permission
    Wait Until Page Contains    Permission Name    
    Wait Until Page Contains    Submit
    Wait Until Page Contains    Back  
    # Back to index.blade.php
    Click Element    ${PERMISSION_URL}    
    # Verify show.blade.php
    Click Element    ${SHOW_PERMISSION_DEMO_URL}
    Wait Until Page Contains    Permissions 
    Wait Until Page Contains    Permission Name
    Wait Until Page Contains    Back
    # Back to index.blade.php    
    Click Element    xpath=(//a[contains(@href, '/permissions')])[2]
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    Edit Permission    
    Wait Until Page Contains    Permission Name    
    Wait Until Page Contains    Submit
    Wait Until Page Contains    Back
    # Back to index.blade.php
...
Verify Department Page English
    ...
    Wait Until Page Contains    Back
    # Back to index.blade.php    
    Click Element    xpath=(//a[contains(@href, '/departments')])[2]
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
...
Verify Manage Expertise Page English
    Scroll Element Into View    ${MANAGE_EXPERTISE_URL}
    Click Element    ${MANAGE_EXPERTISE_URL}
    # Verify index.blade.php
    Wait Until Page Contains    Manage Expertise
    Wait Until Page Contains    No.
    Wait Until Page Contains    Teacher Name
    Wait Until Page Contains    Expertise Name
    Wait Until Page Contains    Action
    Wait Until Page Contains    Search:
    Wait Until Page Contains    Previous
    Wait Until Page Contains    Next        
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    Edit Expertise 
    Wait Until Page Contains    Expertise Name (EN)
    Wait Until Page Contains    Expertise Name (TH) 
    Wait Until Page Contains    Expertise Name (CN)
    Wait Until Page Contains    Submit
    Wait Until Page Contains    Cancel
    # Back to index.blade.php
    Click Element    xpath=(//a[contains(@href, '/experts')])[2]    
    # Verify Delete Message
    Click Element    xpath=(//button[@title='Delete'])[1]
    Wait Until Page Contains    Are you sure?
    Wait Until Page Contains    If you delete this, it will be gone forever.
...
Verify Dashboard Page Thai
    ...
    Wait Until Page Contains    ผู้ดูแลระบบ                
...
Verify User Page Thai  
    ...
    Click Element    ${USER_URL}
    # Verify index.blade.php
    Wait Until Page Contains    ผู้ใช้
    Wait Until Page Contains    เพิ่มผู้ใช้
    Wait Until Page Contains    นำเข้าผู้ใช้ใหม่
    Wait Until Page Contains    ชื่อผู้ใช้
    Wait Until Page Contains    สาขาวิชา
    Wait Until Page Contains    อีเมล
    Wait Until Page Contains    บทบาท
    Wait Until Page Contains    ดำเนินการ
    Wait Until Page Contains    ค้นหา:
    Wait Until Page Contains    ย้อนหลัง
    Wait Until Page Contains    ถัดไป  
    # Verify create.blade.php
    Click Element    ${CREATE_USER_URL}
    Wait Until Page Contains    สร้างผู้ใช้
    Wait Until Page Contains    กรอกรายละเอียดผู้ใช้
    Wait Until Page Contains    ชื่อ (ไทย)
    Wait Until Page Contains    นามสกุล (ไทย)
    Wait Until Page Contains    ชื่อ (อังกฤษ)
    Wait Until Page Contains    นามสกุล (อังกฤษ)
    Wait Until Page Contains    ชื่อ (จีน)
    Wait Until Page Contains    นามสกุล (จีน)
    Wait Until Page Contains    อีเมล
    Wait Until Page Contains    รหัสผ่าน
    Wait Until Page Contains    ยืนยันรหัสผ่าน
    Wait Until Page Contains    บทบาท
    Wait Until Page Contains    สาขาวิชา
    Wait Until Page Contains    หลักสูตร
    Wait Until Page Contains    ยืนยัน
    Wait Until Page Contains    ยกเลิก
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify Import new user
    Click Element    ${IMPORT_NEW_USER_URL}
    Wait Until Page Contains    นำเข้าไฟล์ Excel หรือ CSV
    Wait Until Page Contains    ยืนยัน
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify show.blade.php
    Click Element    ${SHOW_USER_DEMO_URL}
    Wait Until Page Contains    รายละเอียดผู้ใช้ 
    Wait Until Page Contains    รายละเอียดของผู้ใช้
    Wait Until Page Contains    ชื่อเต็ม (ไทย)
    Wait Until Page Contains    ชื่อเต็ม (อังกฤษ)
    Wait Until Page Contains    ชื่อเต็ม (จีน)
    Wait Until Page Contains    อีเมล
    Wait Until Page Contains    บทบาท
    Wait Until Page Contains    รหัสผ่าน
    Wait Until Page Contains    กลับ
    ...
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@data-original-title='Edit'])[1]
    Wait Until Page Contains    แก้ไขผู้ใช้     
    Wait Until Page Contains    แก้ไขรายละเอียดผู้ใช้
    Wait Until Page Contains    ชื่อ (ไทย)
    Wait Until Page Contains    นามสกุล (ไทย)
    Wait Until Page Contains    ชื่อ (อังกฤษ)
    Wait Until Page Contains    นามสกุล (อังกฤษ)
...
Verify Role Page Thai
    ...
    Wait Until Page Contains    บทบาท
    Wait Until Page Contains    เพิ่ม
    Wait Until Page Contains    ชื่อบทบาท
    Wait Until Page Contains    ดำเนินการ
    # Verify create.blade.php
    Click Element    ${CREATE_ROLE_URL}
    Wait Until Page Contains    สร้างบทบาท
    Wait Until Page Contains    ชื่อบทบาท
    ...
    Click Element    ${SHOW_ROLE_DEMO_URL}
    Wait Until Page Contains    บทบาท
    Wait Until Page Contains    รายละเอียดบทบาท
    Wait Until Page Contains    ชื่อบทบาท
    Wait Until Page Contains    สิทธิ์การใช้งาน
    Wait Until Page Contains    กลับ
    # Back to index.blade.php
    ...
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    แก้ไขบทบาท     
    Wait Until Page Contains    ชื่อบทบาท
    Wait Until Page Contains    สิทธิ์การใช้งาน
    Wait Until Page Contains    ยืนยัน
    Wait Until Page Contains    กลับ
...
Verify Permission Page Thai
    ...
    Wait Until Page Contains    สิทธิ์การใช้งาน
    Wait Until Page Contains    เพิ่ม
    Wait Until Page Contains    ชื่อสิทธิ์การใช้งาน
    Wait Until Page Contains    ดำเนินการ
    Wait Until Page Contains    ค้นหา:
    Wait Until Page Contains    ย้อนหลัง
    Wait Until Page Contains    ถัดไป    
    # Verify create.blade.php
    Click Element    ${CREATE_PERMISSION_URL}
    Wait Until Page Contains    สร้างสิทธิ์การใช้งาน
    Wait Until Page Contains    ชื่อสิทธิ์การใช้งาน
    Wait Until Page Contains    ยืนยัน
    Wait Until Page Contains    กลับ  
    # Back to index.blade.php
    ...
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    แก้ไขสิทธิ์การใช้งาน    
    Wait Until Page Contains    ชื่อสิทธิ์การใช้งาน   
    Wait Until Page Contains    ยืนยัน
    Wait Until Page Contains    กลับ
    # Back to index.blade.php
...
Verify Manage Expertise Page Thai
    ...
    Click Element    ${MANAGE_EXPERTISE_URL}
    # Verify index.blade.php
    Wait Until Page Contains    จัดการความเชี่ยวชาญ
    Wait Until Page Contains    ลำดับที่ 
    Wait Until Page Contains    ชื่ออาจารย์
    ...
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    แก้ไขความเชี่ยวชาญ
    Wait Until Page Contains    ชื่อความเชี่ยวชาญ (อังกฤษ)
    Wait Until Page Contains    ชื่อความเชี่ยวชาญ (ไทย) 
    Wait Until Page Contains    ชื่อความเชี่ยวชาญ (จีน)
    Wait Until Page Contains    ยืนยัน
    Wait Until Page Contains    ยกเลิก
    # Back to index.blade.php
    Click Element    xpath=(//a[contains(@href, '/experts')])[2]    
...
Verify User Page Chinese
    ...
    Click Element    ${USER_URL}
    # Verify index.blade.php
    Wait Until Page Contains    用户
    Wait Until Page Contains    添加
    Wait Until Page Contains    导入新用户
    Wait Until Page Contains    用户名
    Wait Until Page Contains    部门
    Wait Until Page Contains    电子邮件
    Wait Until Page Contains    角色
    Wait Until Page Contains    操作
    Wait Until Page Contains    搜索:
    Wait Until Page Contains    上一页
    Wait Until Page Contains    下一页  
    # Verify create.blade.php
    Click Element    ${CREATE_USER_URL}
    Wait Until Page Contains    创建用户
    Wait Until Page Contains    输入用户详情
    Wait Until Page Contains    名字 (泰文)
    Wait Until Page Contains    姓氏 (泰文)
    Wait Until Page Contains    名字 (英文)
    Wait Until Page Contains    姓氏 (英文)
    ...
    Wait Until Page Contains    电子邮件
    Wait Until Page Contains    密码
    Wait Until Page Contains    确认密码
    Wait Until Page Contains    角色
    Wait Until Page Contains    部门
    Wait Until Page Contains    项目
    Wait Until Page Contains    提交
    Wait Until Page Contains    取消
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify Import new user
    Click Element    ${IMPORT_NEW_USER_URL}
    Wait Until Page Contains    导入Excel或CSV文件
    Wait Until Page Contains    提交
    # Back to index.blade.php
    Click Element    ${USER_URL}
    # Verify show.blade.php
    Click Element    ${SHOW_USER_DEMO_URL}
    Wait Until Page Contains    用户详情
    Wait Until Page Contains    用户描述
    Wait Until Page Contains    名字 (泰文)
    Wait Until Page Contains    名字 (英文)
    Wait Until Page Contains    名字 (中文)
    Wait Until Page Contains    电子邮件
    ...
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@data-original-title='Edit'])[1]
    Wait Until Page Contains    编辑用户   
    Wait Until Page Contains    编辑用户详情
    Wait Until Page Contains    名字 (泰文)
    Wait Until Page Contains    姓氏 (泰文)
    Wait Until Page Contains    名字 (英文)
    Wait Until Page Contains    姓氏 (英文)
...
Verify Role Page Chinese
    ...
    Wait Until Page Contains    角色
    Wait Until Page Contains    添加
    Wait Until Page Contains    角色名称
    Wait Until Page Contains    操作
    # Verify create.blade.php
    Click Element    ${CREATE_ROLE_URL}
    Wait Until Page Contains    创建角色
    Wait Until Page Contains    角色名称
    Wait Until Page Contains    权限
    Wait Until Page Contains    提交
    Wait Until Page Contains    取消  
    # Back to index.blade.php
    Click Element    ${ROLE_URL}    
...
Verify Manage Expertise Page Chinese
    ...
    Click Element    ${MANAGE_EXPERTISE_URL}
    # Verify index.blade.php
    Wait Until Page Contains    管理专长
    Wait Until Page Contains    编号 
    Wait Until Page Contains    教师名称
    Wait Until Page Contains    专长名称
    Wait Until Page Contains    操作
    Wait Until Page Contains    搜索:
    Wait Until Page Contains    上一页
    Wait Until Page Contains    下一页       
    # Verify Edit.blade.php
    Click Element    xpath=(//a[@title='Edit'])[1]
    Wait Until Page Contains    编辑专长
    Wait Until Page Contains    专长名称 (英文)
    Wait Until Page Contains    专长名称 (泰文)
    Wait Until Page Contains    专长名称 (中文)
    Wait Until Page Contains    提交
    Wait Until Page Contains    取消
    # Back to index.blade.php
    Click Element    xpath=(//a[contains(@href, '/experts')])[2]    
