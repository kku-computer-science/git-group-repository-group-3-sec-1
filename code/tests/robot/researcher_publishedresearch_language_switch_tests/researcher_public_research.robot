...
${PUBLISHED_RESEARCH_URL}        http://127.0.0.1:8000/papers
...
*** Test Cases ***
Test Language Switching On Researcher Published Research
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้างานวิจัยที่ตีพิมพ์ในส่วนของผู้วิจัย   
    Go To    ${PUBLISHED_RESEARCH_URL}
    Verify Language    Published research
    Switch Language    th
    Verify Language    ผลงานวิจัยที่ตีพิมพ์      
    Switch Language    cn
    Verify Language    已发表的研究    
