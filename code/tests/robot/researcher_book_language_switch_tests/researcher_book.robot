...
${RESEARCHER_BOOK_URL}        http://127.0.0.1:8000/books
...
*** Test Cases ***
Test Language Switching On Researcher Book
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้าหนังสือในส่วนของผู้วิจัย   
    Go To    ${RESEARCHER_BOOK_URL}
    Verify Language    Book
    Switch Language    th
    Verify Language    หนังสือ      
    Switch Language    cn
    Verify Language    书籍    
