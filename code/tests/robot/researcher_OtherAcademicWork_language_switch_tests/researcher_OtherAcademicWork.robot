...
${OTHER_ACADEMIC_WORK_URL}        http://127.0.0.1:8000/patents
...
*** Test Cases ***
Test Language Switching On Researcher Patent
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้าผลงานวิชาการอื่นๆในส่วนของผู้วิจัย   
    Go To    ${OTHER_ACADEMIC_WORK_URL}
    Verify Language    Other Academic Works (Patents, Utility Models, Copyrights)
    Switch Language    th
    Verify Language    ผลงานวิชาการอื่นๆ (สิทธิบัตร, อนุสิทธิบัตร,ลิขสิทธิ์)      
    Switch Language    cn
    Verify Language    其他学术作品    
