...
${USER_PROFILE_URL}        http://127.0.0.1:8000/profile
...
Test Language Switching On Researcher Dashboard        
    ...
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้าโปรไฟล์ในส่วนของผู้วิจัย   
    Go To    ${USER_PROFILE_URL}
    Verify Language     Account
    Verify Language     Password
    Verify Language     Expertise
    Verify Language     Education 
    Switch Language    th
    Verify Language     บัญชี 
    Verify Language     รหัสผ่าน 
    Verify Language     ความเชี่ยวชาญ 
    Verify Language     การศึกษา 
    Switch Language    cn
    Verify Language     帐户 
    Verify Language     密码 
    Verify Language     专长 
