...
${MANAGE_FUND_URL}        http://127.0.0.1:8000/funds
...
*** Test Cases ***
Test Language Switching On Researcher Fund     
    [Setup]    Reset Language To English
    [Documentation]    ทดสอบการเปลี่ยนภาษาบนหน้าจัดการทุนในส่วนของผู้วิจัย   
    Go To    ${MANAGE_FUND_URL}
    Verify Language    Research Grant    
    Switch Language    th
    Verify Language    ทุนวิจัย      
    Switch Language    cn
    Verify Language    研究基金       
